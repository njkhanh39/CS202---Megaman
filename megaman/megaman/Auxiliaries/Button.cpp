...
Button::Button(float x, float y, float width, float height, sf::Font font, int fontsize, std::string text, sf::Color idleColor,
	sf::Color hoverColor, sf::Color activeColor) {
...
Button::Button(float x, float y, float width, float height, sf::Font font, int fontsize, std::string text,sf::Color textColor, sf::Color idleColor,
	sf::Color hoverColor, sf::Color activeColor) {
...
void Button::Update(sf::Vector2f mousePos) {
	...
	case BTN_HOVER:
		...
		this->shape.setOutlineColor(this->hoverColor);
		break;
	case BTN_ACTIVE:
		this->shape.setOutlineThickness(2.f);
		this->shape.setOutlineColor(this->activeColor);
		break;
	default:
